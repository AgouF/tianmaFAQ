...
1. Model/auth provider Start configuring the AI, using OpenAI. Choose OpenAI Codex (ChatGPT OAuth). For specific registration tutorial, see [Claude&ChatGPT&Gemini Registration & Usage](/catalog-2/claude-chatgpt-gemini-registration-usage). Wait for authorization to complete.
...
1. Gateway bind Default selection 127.0.0.1.

1.  Gateway auth Gateway authentication method, default (press Enter) is fine: Token.

1. Tailscale exposure Whether to expose the OpenClaw gateway via Tailscale. For personal use, directly select off.

1. How do you want to provide the gateway token? How to save the gateway token? Press Enter for the default.

1. Gateway token (blank to generate) Gateway access token, leave blank and press Enter.
...
1. Feishu DM policy Private chat policy. Select the first one: Pairing (only private chat after pairing).
...
1. Wait for the installation to finish. Install Gateway service (recommended) Install the gateway service? Select yes, then select the default (press Enter).
...
<RelatedCards :items='[{"title":"Claude&ChatGPT&Gemini Registration & Usage","link":"/catalog-2/claude-chatgpt-gemini-registration-usage"},{"title":"Linux and Server Installation Method","link":"/catalog-2/directory-nesting-333/linux-server-installation"},{"title":"Windows Installation Method","link":"/catalog-2/directory-nesting-333/windows-installation"},{"title":"MAC Install Python Tutorial","link":"/more-info/mac-install-python-tutorial"},{"title":"MAC Install NodeJS Steps","link":"/more-info/mac-install-nodejs-steps"},{"title":"OpenClaw Installation Guide","link":"/more-info/openclaw-installation-guide"},{"title":"MAC Device Security Precautions","link":"/more-info/mac-device-security-precautions"},{"title":"How to Configure OpenAI Gateway","link":"/more-info/how-to-configure-openai-gateway"},{"title":"MAC Switch npm Mirror Source","link":"/more-info/mac-switch-npm-mirror"},{"title":"MAC Install OpenClaw Error","link":"/more-info/mac-install-openclaw-error"},{"title":"MAC Multi-User Environment Security Settings","link":"/more-info/mac-multi-user-security-settings"}]' />