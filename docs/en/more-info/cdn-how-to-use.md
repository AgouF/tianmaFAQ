...
*   **Cost Control**: Be aware of the CDN billing model (usually based on traffic or peak bandwidth), set reasonable alert thresholds, and avoid unexpected costs due to traffic spikes.
